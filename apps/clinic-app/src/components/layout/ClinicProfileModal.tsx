...
export default function ClinicProfileModal({
  isOpen,
  onClose,
  onNavigate,
}: {
      ...
      >
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: 15 }}>
            ...
            <div>
              <h2
                style={{ fontSize: 22, fontWeight: 800, margin: 0, color: 'var(--text-primary)' }}
              >
                Klinika Profili
              </h2>
              <p style={{ margin: '2px 0 0', color: 'var(--text-muted)', fontSize: 13 }}>
                ID: <strong style={{ color: 'var(--text-primary)' }}>CL-24098</strong>
              </p>
            </div>
          </div>
          <button
        ...
        <div style={{ padding: '30px', display: 'flex', flexDirection: 'column', gap: 20 }}>
          ...
          >
            <div>
              <div style={{ fontSize: 12, color: '#94a3b8', marginBottom: 5, letterSpacing: 1 }}>
                BALANS NAZORATI
              </div>
              <div
                style={{ fontSize: 32, fontWeight: 900, color: '#10b981', fontFamily: 'monospace' }}
              >
                1,250,000 <span style={{ fontSize: 16, color: '#64748b' }}>UZS</span>
              </div>
            </div>
            <button
              onClick={() => {
