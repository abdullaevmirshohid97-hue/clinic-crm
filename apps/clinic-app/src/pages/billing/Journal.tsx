...
export default function JournalPage({ onNavigate }){
  ...
  return (
    <div className="page page-journal" style={{ height:'100%', display:'flex', flexDirection:'column', gap: 20 }}>
      ...
      {/* EDIT MODAL */}
      <Modal isOpen={!!editingEntry} onClose={() => setEditingEntry(null)} title={t('common.edit') || "Tahrirlash"}>
        {editingEntry && (
          <div className="form-grid p-4">
             <div className="form-group full-width">
             ...
             <div className="form-actions" style={{ marginTop:20 }}>
               <button className="btn btn-primary" onClick={saveEdit}>{t('common.save') || "Saqlash"}</button>
             </div>
          </div>
        )}
      </Modal>
