      ...
      <div className="page-body">
        ...
        >
          <div className="card-body" style={{ textAlign: 'center', padding: '20px' }}>
            <h3 style={{ color: 'var(--text-secondary)', marginBottom: 5 }}>
              Joriy Live Balans ({date})
            </h3>
            <div
              style={{
                fontSize: 36,
                fontWeight: 'bold',
                color: liveBalance >= 0 ? 'var(--accent-success)' : 'var(--accent-danger)',
              }}
            >
        ...
        <div className="stats-grid" style={{ marginBottom: 20 }}>
          <div
            ...
            style={{ '--card-accent': 'var(--accent-success)' } as React.CSSProperties}
          >
          ...
          <div
            className="card glass-card stat-card"
            style={{ '--card-accent': 'var(--accent-info)' } as React.CSSProperties}
          >
            <div className="stat-icon">💳</div>
            <div className="stat-info">
          ...
          <div
            className="card glass-card stat-card"
            style={{ '--card-accent': 'var(--accent-primary)' } as React.CSSProperties}
          >
            <div className="stat-icon">🔄</div>
            <div className="stat-info">
          ...
          <div
            className="card glass-card stat-card"
            style={{ '--card-accent': 'var(--accent-danger)' } as React.CSSProperties}
          >
            <div className="stat-icon">📝</div>
            <div className="stat-info">
          ...
          <div
            className="card glass-card stat-card"
            style={{ '--card-accent': 'var(--accent-warning)' } as React.CSSProperties}
          >
            <div className="stat-icon">💸</div>
            <div className="stat-info">
        ...
        <div className="card glass-card" style={{ flex: 1 }}>
          <div className="card-header">
            ...
            <button className="btn btn-sm btn-ghost" onClick={loadTransactions}>
              🔄 Yangilash
            </button>
          </div>
                  ...
                  {transactions.length === 0 ? (
                    ...
                    transactions.map((t) => (
                      ...
                      >
                        ...
                        <td>
                          <span
                            style={{ fontWeight: 600, color: getBadgeColor(t.paymentType ?? '') }}
                          >
                        ...
                        <td>
                          <div style={{ fontWeight: 600 }}>
                            {t.patient_name || t.patientNameStr || '—'}
                          </div>
                        ...
                        <td>
                          <b
                            style={{
                              color:
                                t.patientBalance && t.patientBalance > 0
                                  ? 'var(--accent-danger)'
                                  : 'var(--accent-success)',
                            }}
                          >
                        ...
                        <td>
                          {t.shiftType ? (
                            <span
                              className={`badge ${t.shiftType === 'day' ? 'badge-success' : 'badge-warning'}`}
                        ...
                        <td
                          style={{
                            ...
                            fontSize: 15,
                            color:
                              t.type === 'expense' || t.type === 'payout'
                                ? 'var(--accent-danger)'
                                : 'var(--accent-primary)',
                          }}
                        >
                          {t.type === 'expense' || t.type === 'payout' ? '-' : '+'}
                          {formatPrice(t.amount || t.debt)}
                        </td>
                      </tr>
                    ))
                  )}
